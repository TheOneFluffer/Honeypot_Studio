...
function drop(event) {
    ...
    const cowrieConfig = document.getElementById("cowrieConfig");
    const honeydConfig = document.getElementById("honeydConfig");
    const dionaeaConfig = document.getElementById("dionaeaConfig");
    const honeytrapConfig = document.getElementById("honeytrapConfig");

    // Hide all configurations by default
    cowrieConfig.style.display = "none";
    honeydConfig.style.display = "none";
    dionaeaConfig.style.display = "none";
    honeytrapConfig.style.display = "none";

    // Show the relevant configuration
    if (data === "cowrie") {
        cowrieConfig.style.display = "block";
    } else if (data === "honeyd") {
        honeydConfig.style.display = "block";
    } else if (data === "dionaea") {
        dionaeaConfig.style.display = "block";
    } else if (data === "honeytrap") {
        honeytrapConfig.style.display = "block";
    }
}
